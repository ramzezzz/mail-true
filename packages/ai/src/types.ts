...
export type AiFeature =
  ...
  | 'logo.hint'
  /**
   * Свободный разговор с моделью.
   *
   * Стоит особняком от остальных: у всех прочих на входе письмо, а здесь
   * — только то, что человек написал сам. Ни ящик, ни письма, ни
   * настройки сервера сюда не попадают, и модель не получает никаких
   * средств до них добраться.
   */
  | 'chat';
