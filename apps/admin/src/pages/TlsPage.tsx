  ...
  return (
    <Panel title="Выпустить Let's Encrypt">
      <p style={MUTED}>
        ...
        {names.join(', ')} должны уже указывать сюда, а порт 80 быть доступен снаружи. Веб-вход
        при этом продолжает работать: подтверждение отдаёт наш же nginx, гасить его не нужно.
      </p>
