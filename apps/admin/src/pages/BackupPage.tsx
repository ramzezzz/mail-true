        ...
        {result && (
          <div style={{ marginTop: '1rem' }}>
            ...
            */}
            ...
            {result.sieve.pending > 0 && (
              <Notice tone="info">
                Правила ещё пересобираются у {result.sieve.pending} ящик(ов) — их много, и в один
                запрос это не уместилось. Пока идёт, письма у них раскладываются по старым правилам;
                повторять восстановление не нужно.
              </Notice>
            )}
