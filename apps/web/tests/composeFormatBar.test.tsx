 ...
 *
 * Было (research/mailru/03-compose.png — эталон): кнопки подписаны
 ...
 * Буквы Ж/К/Ч/З остаются: у mail.ru начертания подписаны так же.
 */
...
describe('панель форматирования — один набор значков', () => {
  ...
  it('начертания по-прежнему подписаны буквами Ж/К/Ч/З — как у mail.ru', () => {
    render();
    const bar = formatBar();
