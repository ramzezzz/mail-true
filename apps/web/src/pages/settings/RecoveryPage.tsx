...
export function RecoveryPage() {
  ...
  return (
    <>
      ...
      <SettingsLead>
        Когда вы очищаете корзину, письма не исчезают сразу: они лежат в ящике ещё несколько
        дней и всё это время их можно вернуть. Место в ящике они при этом занимают
        по-настоящему — как и любые другие письма.
      </SettingsLead>
      ...
      {available && !loading && (
        <>
          ...
          <div className={styles.setting}>
            ...
            {!scheduledPurge && (
              <p className={styles.warning}>
                Сейчас сервер не может удалять письма по сроку: администратор не настроил
                служебный доступ к почтовому хранилищу. Хранение работает, но освобождать место
                придётся кнопкой выше.
              </p>
            )}
          </div>
          ...
          <SettingsHint>
            ...
            Письма ждут своего срока в служебной папке ящика: в почтовой программе на телефоне
            или в Thunderbird она видна под именем «Recovery», и это не поломка.
          </SettingsHint>
        </>
      )}
    </>
