/**
 * Переключатель привычный почтовый интерфейс (BaseSwitch): дорожка 32×20, бегунок 16×16
 * (--mt-switch-*, размеры и обоснование — в themes.css). Внутри — настоящий
 * input[type=checkbox], поэтому работают клавиатура, форма и экранные
 * читалки без единого aria-костыля.
