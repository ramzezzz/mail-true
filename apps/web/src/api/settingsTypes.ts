...
export interface CollectorAccount {
   ...
   * укладывается: сервер переносит сколько успел и продолжит с того же
   * места следующим заходом. Ошибки нет, но и «обновлено» сказать
   * нельзя — иначе человек решит, что приехало всё.
   */
  note: string | null;
}
