 ...
 *
 * Так же устроено «От кого» в привычных почтовых интерфейсах: свой адрес и подключённые чужие
 ...
 * сессия, и отправка из чужой сессии обошла бы проверку пароля. в привычных почтовых интерфейсах
