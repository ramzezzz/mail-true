  ...
  return (
    <Modal title="Горячие клавиши" onClose={onClose} className={styles.card}>
      ...
      <p className={styles.note}>
        Буквенная клавиша определяется по своему месту на клавиатуре, поэтому работает и в русской
        раскладке. Пока курсор стоит в поле ввода, клавиши принадлежат полю.
      </p>
    </Modal>
  );
}
