 ...
 *
 *   mail.ru — строки состояния под списком писем У НЕГО НЕТ. Место в вёрстке
 *     предусмотрено, но схлопнуто: `--vkui--octavius_size_portal-footer_height
 *     --regular: 0px` (research/mailru/design-tokens-raw.json), и на снимке
 *     research/mailru/01-inbox.png список упирается в край окна. Занятое место
 *     mail.ru показывает в другом месте — карточкой в «Настройки → Главная»
 *     (research/mailru/04-settings.png): заголовок «Занято 400 МБ из 8 ГБ»,
 ...
 *
 *   Не взято: ссылки подвала («О компании», «Реклама», «Помощь») — у mail.ru
