/**
 * Окно «Создание фильтра» (эталонные снимки интерфейса и
 ...
 * Свёрнутый вид ровно такой же, как в привычных почтовых интерфейсах: редкие действия не мозолят
...
const FIELD_ORDER: readonly FilterField[] = [
  ...
  'attachment',
  'size',
  // Заголовки переадресованного письма. Стоят последними — нужны редко, но
  // без них правило с таким условием нельзя было даже прочитать: список
  // показывал «Поле „От“», а фильтровало правило совсем по другому полю.
  'resent-from',
  'resent-to',
];
