 ...
 * ------------------------------------------------------------------
 * Каталог сертификатов (infra/data/certs) в контейнер api смонтирован —
 * ради раздела «Сертификат» и отчёта о продлении, — но срок здесь всё
 * равно читается не оттуда. Файл на диске отвечает на вопрос «что мы
 * положили», а нужен ответ на вопрос «что служба ОТДАЁТ клиенту». Это
 * разные вещи:
