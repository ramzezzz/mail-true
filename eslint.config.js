...
export default tseslint.config(
  ...
  ...tseslint.configs.recommended,
  {
    ...
    languageOptions: {
      parserOptions: {
        /*
         * Файлы вне tsconfig (конфигурации сборки в корне) иначе не
         * разбираются вовсе. Шаблон намеренно узкий: сюда нельзя вносить
         * то, что уже покрыто tsconfig, — TypeScript на это отвечает
         * «файл не найден проектом» для ВСЕХ файлов сразу, и разбор
         * рассыпается там, где до этого работал.
         */
