...
-- переноса (migrate_messages / migrate_cursors, их заводит сам пакет
-- packages/migrate при первом обращении). Здесь — только само задание:
-- что переносим, куда, чем закончилось.
--
-- ------------------------------------------------------------------
-- ПАРОЛИ
--
